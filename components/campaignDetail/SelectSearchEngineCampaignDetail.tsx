...
interface SelectSearchEngineCampaignDetailProps {
  control: Control<FormValues>
}
const SelectSearchEngineCampaignDetail: React.FC<SelectSearchEngineCampaignDetailProps> = ({ control }) => {
  return (
    <Controller
      control={control}
...
export default SelectSearchEngineCampaignDetail
