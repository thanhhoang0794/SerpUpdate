  ...
  return (
    <ChakraSlider.Root ref={ref} thumbAlignment="center" {...rest}>
      ...
      <ChakraSlider.Control mb={hasMarkLabel ? '4' : undefined}>
        ...
        {value?.map((_: any, index: React.Key | null | undefined) => (
          <ChakraSlider.Thumb key={index} index={Number(index)}>
      ...
      {marks?.length && (
        <ChakraSlider.MarkerGroup>
          {marks.map((mark: { value: any; label: any; }, index: React.Key | null | undefined) => {
